...
public class Ex19Aula2
{
  public static void main(String[] args)
   ...
   if(numero1 > numero2){
      JOptionPane.showMessageDialog(null, "A ordem decrescente sera: " + numero1 +", " + numero2);
      }
   
     else {
      JOptionPane.showMessageDialog(null, "A ordem decrescente sera: " + numero2 + ", " + numero1);
     }
   }
}   
